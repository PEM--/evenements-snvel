...
Le SNVEL est un syndicat professionnel créé en 1993. Il est immatriculé au répertoire SIRET sous le numéro 399 284 298 00011 et son siège social est situé 10, Place Léon Blum à Paris (75 011).  Syndicat représentatif au service des vétérinaires praticiens, le SNVEL est la seule organisation professionnelle vétérinaire ayant pour but de sauvegarder et de défendre les intérêts professionnels, moraux et matériels, de rechercher et de mettre en œuvre les moyens propres à faire connaître et apprécier le rôle du vétérinaire et à promouvoir l'image de la profession.

Il est présent et entendu dans toutes les organisations nationales et internationales où les intérêts de la profession sont en jeu.

Conditions générales de vente des inscriptions pour les "Évènements du SNVEL" » (ci-après les événements).
------------------------------------------------------------------------

Les évènements sont organisés par le SNVEL (ci-après « L'organisateur »). La vente des inscriptions s’effectuera en ligne sur le site https://evenements-snvel.fr (ci-après « le site »). La commande en ligne aux Événements confère au visiteur la qualité de « Client » et emporte de plein droit son adhésion et son acceptation des présentes conditions générales de vente. La commande du Client est soumise aux présentes conditions générales qui prévalent sur tout document émanant du Client. L’Organisateur pourra modifier unilatéralement les présentes conditions générales. Toute modification de ces dispositions sera opposable au Client dès sa communication, et cela par quelque moyen que ce soit.

**Article 1 : Objet du Contrat**

Les présentes Conditions générales de vente ont pour objet de définir les modalités de vente des accès aux événements. Le programme, la date, le lieu, la durée des événements ainsi que le prix des accès sont également indiqués sur le Site. Le Client reconnaît en avoir pris connaissance et les avoir acceptés sans réserve. Le programme des événements est conçu par l’Organisateur avec le plus grand soin et la plus grande exactitude possible. Si, malgré tous les efforts de l’Organisateur, les circonstances l’y obligent, l’Organisateur se réserve le droit d’en modifier le programme, le lieu ainsi que la durée, sans que le Client ne puisse prétendre à une quelconque indemnisation.

**Article 2 : Description de l’offre**

Sauf mention contraire, et sous réserve du respect des présentes, sont inclus dans l’offre et par options : la participation aux conférences, aux ateliers, évènements ou réunions. Dans certains cas, l'offre peut inclure des prestations hôtelières ou des repas. Les diverses activités sont énoncées dans la programmation de https://evenements-snvel.fr.
...
Le paiement des tickets par le Client sur le site https://evenement-snvel.fr s’effectue exclusivement par cartes bancaires des réseaux CARTE BLEUE/VISA, MASTERCARD, AMERICAN EXPRESS, DISCOVER et MAESTRO ou par chèque.
...
Les paiements électroniques effectués dans le cadre des transactions réalisées sur le site https://evenements-snvel.fr sont sécurisés, par utilisation du procédé de cryptage « SSL ». Le SNVEL utilise pour les dits paiements électroniques, la solution « Braintree » fournie par «Braintree ».
...
S’il souhaite ultérieurement ne plus recevoir d’informations de l'organisateur, le client pourra se désabonner à l’aide du lien hypertexte “Se désinscrire” situé en bas de page des courriels d’information.
...
Pour exercer ces droits, le client pourra adresser sa requête à : evenements@snvel.fr ou à : SNVEL - 10, Place Léon Blum - 75011 Paris.
